...
BED = '/home/biacaporusso/Compiladores/trabalho_1/testes'
BSD = '/home/biacaporusso/Compiladores/trabalho_1/minhas_saidas'
OFICIAL = '/home/biacaporusso/Compiladores/trabalho_1/saidas_padrao'
src = '/home/biacaporusso/Compiladores/trabalho_1'
...
for f in inputs:
    ...
    with open(input_file, 'r') as stdin, open(output_file, 'w') as stdout:
        subprocess.Popen(["./trabalho_1"], stdin=stdin, stdout=stdout).wait()
